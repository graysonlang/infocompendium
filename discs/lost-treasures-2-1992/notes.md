...
- **Interpreters match Doherty's size table** (11394=3L, 11402=3M2, 12004=3N, 12640=4A, 12682=4E, 12688=4D, 33946=5J, 47442=6.68, 47528=6.71) including Shogun's `SHOGUN.EXE` at 47,402 bytes - a size the other discs never showed, but present in Doherty's full interpreter table as a build of 6.68.
