...
| Leather Goddesses of Phobos | v5 / v3 | r4.880405 | r59.860730 | **no** | Mac only |
...
The hints column follows release history: the late releases carry the on-screen hint system natively on both platforms (Border Zone, Nord and Bert, Sherlock, and the V6 Arthur and Zork Zero - though not Journey, whose menu-driven interface shipped without one, and not Beyond Zork), while Planetfall and Leather Goddesses have hints only where a platform got the Solid Gold build.
So a Mac owner of this disc has in-game hints in seven titles, a PC owner in five.
