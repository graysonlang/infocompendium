...
Columns: **Box** = original boxed retail media, checked where the build has been verified first hand from the physical diskettes - the 1989 Zork Zero floppies, and the 8-bit diskettes marked ‡ - and "doc" where a documented boxed release is the build's only known carrier; **MP** = Masterpieces (1996); **LTOI1**/**LTOI2** = the 1992 Lost Treasures CDs; **Leak** = the historicalsource repositories (2019), where "hist" marks a build present only in a repository's git history.
